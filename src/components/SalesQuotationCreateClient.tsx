  ...
  useEffect(() => {
    fetch("/api/customers")
      ...
      .then((d) => {
        ...
        setCustomers(rows);
        // R80 GAP-8: same rule as the Sales Order form -- Customer is the one
        // required field this seeding can answer (a description and a rate are
        // also required on every line, and those are the user's to type), and
        // an org with a single customer on file has already answered it. Editable, and it stops seeding once a second
        // customer exists.

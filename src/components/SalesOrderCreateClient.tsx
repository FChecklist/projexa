...
// Real-screen conversion (2026-08-30): replaces SalesOrdersClient.tsx's old
// "New Sales Order" Dialog popup with a real create screen. Same fields,
// unchanged.
...
export default function SalesOrderCreateClient() {
  ...
  async function create() {
    ...
    setSubmitting(true);
    try {
      const order = await fetchJson<{ id: string }>("/api/sales-orders", {
      ...
      toast.error(errorMessage(err, "Couldn't create sales order"));
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <ObjectScreen
      breadcrumb="Sales Orders / New Sales Order"

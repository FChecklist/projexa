...
export type BoqLineGridProps = {
  lines: LineItemDraft[];
  /** The org-configurable trade list from GET /api/scope/categories. */
  categories: string[];
...
export default function BoqLineGrid({ lines, categories, onUpdate, onRemove, onAdd }: BoqLineGridProps) {
        ...
        return (
          <div key={i} className="flex flex-wrap items-start gap-2">
            ...
            <div className={COL.category}>
              <Select
                value={line.category?.trim() ? line.category : undefined}
                onValueChange={(value) => onUpdate(i, "category", value)}
              >
                <SelectTrigger aria-label={`Line ${i + 1} Category`} className="w-full">

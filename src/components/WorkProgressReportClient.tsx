    ...
    <div className="space-y-4">
      <Card className="shadow-card">
        <CardContent className="flex flex-wrap items-end gap-3 p-4">
          ...
          <Button
            onClick={() => {
              // The strip first, then the URL sync (D-02's shareable-link
              // rule) and the run. `navigate: false` because this IS the
              // report screen -- pushing its own route again would throw
              // away the from/to the user just picked.

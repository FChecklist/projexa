...
// R67 F-34 (R-290). Lane F2's suite for the `loading` variant of the fork.
//
// MERGE NOTE: lanes F2 and D3 each wrote the first test file for this
// component, from no common ancestor. They are kept as two files -- this one
// for F-34's loading frame, KitObjectScreen.test.tsx for D-33's deleteLabel
// and secondaryAction -- because each carries its own harness, and splicing
// them by hand would risk silently weakening whichever lost. Both run.
//
// The acceptance is a Playwright screenshot at 300 ms of a

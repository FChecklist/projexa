...
//
// MERGE NOTE: lanes F2 and D3 each wrote a suite for this component from no
// common ancestor. F2's -- for the `loading` variant it added -- keeps the
// canonical KitObjectScreen.test.tsx; this one, for the two props D-33 added,
// lives beside it. Two files because each carries its own harness, and
// splicing them by hand would risk silently weakening whichever lost.
//

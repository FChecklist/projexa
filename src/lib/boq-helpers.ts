...
export type LineItemDraft = {
  ...
  // R67 D-24: the per-line trade category (compliance.construction_boq_line_items
  // .category, drizzle/0528). Optional -- a line without one reads as
  // "Uncategorized" in the WPR's category-wise view.
  category?: string;

...
export async function GET(_request: NextRequest, { params }: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json({ error: err instanceof VeridianApiError ? err.message : "Failed to load sales order" }, { status: err instanceof VeridianApiError ? err.status : 502 });
  }
}

...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({ error: err instanceof VeridianApiError ? err.message : "Failed to load chart of accounts" }, { status: err instanceof VeridianApiError ? err.status : 502 });
  }
}

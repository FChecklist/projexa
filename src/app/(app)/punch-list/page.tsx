...
export default async function PunchListPage({ searchParams }: { searchParams: Promise<{ projectId?: string }> }) {
  ...
  return (
    <>
      <main className="flex-1 space-y-6 p-6">
        ...
        {project && <PunchListClient projectId={project.id} />}
      </main>
    </>
  );
}

...
export default async function RfisPage({ searchParams }: { searchParams: Promise<{ projectId?: string }> }) {
  ...
  return (
    <>
      <main className="flex-1 space-y-6 p-6">
        ...
        {project && <RfisClient projectId={project.id} />}
      </main>
    </>
  );
}

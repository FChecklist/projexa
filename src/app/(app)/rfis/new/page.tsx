...
import RfiCreateClient from "@/components/RfiCreateClient";

export default async function RfiNewPage({ searchParams }: { searchParams: Promise<{ projectId?: string }> }) {
  ...
  return (
    <div className="flex-1">
      <RfiCreateClient projectId={project.id} />
    </div>
  );
}

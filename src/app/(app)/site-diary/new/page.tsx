...
import SiteDiaryCreateClient from "@/components/SiteDiaryCreateClient";

export default async function SiteDiaryNewPage({ searchParams }: { searchParams: Promise<{ projectId?: string }> }) {
  ...
  return (
    <div className="flex-1">
      <SiteDiaryCreateClient projectId={project.id} />
    </div>
  );
}
